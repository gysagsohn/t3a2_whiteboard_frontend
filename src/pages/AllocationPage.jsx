...
export default function AllocationPage() {
    ...
    const loadAllocations = async () => {
        // Fetch allocations from the backend and update state
        try {
                ...
                <ul className="allocation-list">
                    {allocations.map(allocation => (
                        <li key={allocation._id}>
                            {/* Fallback to 'No Asset' if allocation.asset is null */}
                            {allocation.asset ? allocation.asset.assetnumber : 'No Asset'} - 
                            {/* Fallback to 'No Operator' if allocation.operator is null */}
                            {allocation.operator ? allocation.operator.operatorName : 'No Operator'} - 
                            {/* Fallback to 'No Client' if allocation.client is null */}
                            {allocation.client ? allocation.client.clientname : 'No Client'} - 
